...
urlpatterns = [
    ...
    path('facturacion/agregar-por-codigo/', views.facturacion_agregar_por_codigo, name='facturacion_agregar_por_codigo'),

    # --- 📱 LECTOR DE CÓDIGO DE BARRAS POR CELULAR (app externa GET/POST) ---
    path('escaner/recibir/', views.escaner_recibir, name='escaner_recibir'),
    path('escaner/consultar/', views.escaner_consultar, name='escaner_consultar'),
